...
module SmartAnswer::Calculators
  class MinimumWageCalculatorTest < ActiveSupport::TestCase
    context "Validation" do
      ...
      context 'for accommodation usage' do
        should 'not accept days per week of less than or equal to 0' do
          refute @calculator.valid_accommodation_usage?(0)
        end
        ...
        should 'accept days per week greater than or equal to 1' do
          assert @calculator.valid_accommodation_usage?(1)
        end
    ...
    context "#apprentice_elligible_for_minimum_wage?" do
      setup do
        @calculator = MinimumWageCalculator.new
      end
      ...
      should 'return true if date is equal to or later than 1st October 2010' do
        ...
        assert @calculator.apprentice_elligible_for_minimum_wage?
      end

      should 'return false if date is earlier than 1st October 2010' do
        @calculator.date = Date.parse('2010-09-30')
        refute @calculator.apprentice_elligible_for_minimum_wage?
      end
    end
