...
class AdditionalCommodityCodeTest < ActiveSupport::TestCase
  ...
  context "answer 25" do
    ...
    should "ask how much sucrose the product contains" do
      ...
      assert_current_node :how_much_sucrose_up_to_50_percent_or_more?
    end
  end
  ...
  context "answer 75" do
    ...
    should "ask how much sucrose the product contains" do
      ...
      assert_current_node :how_much_sucrose_up_to_5_percent_or_more?
    end
  end
  context "answer 5" do
    setup do
    ...
    should "ask how much sucrose the product contains" do
      ...
      assert_current_node :how_much_sucrose_up_to_70_percent_or_more?
    end
    context "answer 30" do
      ...
      context "answer 0" do
        should "ask how much milk protein the product contains" do
          add_response 0
          assert_current_node :how_much_milk_protein_up_to_60_percent_or_more?
        end
      end
      context "answer 9" do
        should "ask how much milk protein the product contains" do
          add_response 9
          assert_current_node :how_much_milk_protein_up_to_18_percent_or_more?
        end
      end
