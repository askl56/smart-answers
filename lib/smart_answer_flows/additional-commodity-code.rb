    ...
    def define
      ...
      multiple_choice :how_much_milk_fat? do
        ...
        next_node do |response|
          ...
          when 6
            :how_much_milk_protein_up_to_15_percent_or_more?
          when 9, 12
      ...
      # Q3d
      multiple_choice :how_much_milk_protein_up_to_15_percent_or_more? do
        option 0  # 0-3.99
        option 4  # 4-14.99
      ...
      # Q3ef
      multiple_choice :how_much_milk_protein_up_to_18_percent_or_more? do
        option 0  # 0-5.99
        option 6  # 6-17.99
